...
public class PointDatabase
{
	 ...
	 */
	public String getName(double x, double y) { return _factory.get(x, y).getName(); }
	
	/**
	 * gets the name of a given point
	 * 
	 * @param pt - Point that name is extracted from
	 * @return String - the name of the given Point
	 */
	public String getName(Point pt) { return _factory.get(pt).getName(); }
